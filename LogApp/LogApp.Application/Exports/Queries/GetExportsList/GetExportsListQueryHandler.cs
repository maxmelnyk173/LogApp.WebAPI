...
{
    public class GetExportsListQueryHandler : IRequestHandler<GetExportsListQuery, List<ExportVm>>
    {
        private readonly IApplicationDbContext _context;

        public GetExportsListQueryHandler(IApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<List<ExportVm>> Handle(GetExportsListQuery request, CancellationToken cancellationToken)
        {
