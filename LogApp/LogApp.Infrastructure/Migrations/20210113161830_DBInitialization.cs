        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TruckReleasedTime = table.Column<DateTime>(nullable: false),
                    DeliveryDate = table.Column<DateTime>(nullable: false),
                    LogisticsNotes = table.Column<string>(nullable: true),
                    InventoryOrSecurityNotes = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exports_Carriers_CarrierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Imports_Carriers_CarrierId",
                        column: x => x.CarrierId,
                        principalTable: "Carriers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackingType = table.Column<int>(nullable: false),
                    GoodsQuantity = table.Column<int>(nullable: false),
                    Dimensions = table.Column<string>(nullable: true),
                    Weight = table.Column<int>(nullable: false),
                    Stackability = table.Column<int>(nullable: false),
                    ...
                    ExportId = table.Column<Guid>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Imports_ImportId",
                        column: x => x.ImportId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exports_CarrierId",
                table: "Exports",
                column: "CarrierId");

            migrationBuilder.CreateIndex(
                name: "IX_Imports_CarrierId",
                table: "Imports",
                column: "CarrierId");
